...
var orderentity = /** @class */ (function () {
    ...
    orderentity.prototype.index = function () {
    ...
    orderentity.prototype.getorderbyid = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    orderentity.prototype.getorderbyuserid = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    orderentity.prototype.create = function (o) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, createdorder, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add new order ".concat(o.id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    orderentity.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
