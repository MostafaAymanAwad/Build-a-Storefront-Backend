...
describe('Testing order Model', function () {
    describe('Testing order model methods to be defined', function () {
        it('should have an index method', function () {
            expect(order_entity.index).toBeDefined();
        });
        it('should have a getorderbyid method', function () {
        ...
        it('should have a getorderbyuserid method', function () {
            expect(order_entity.getorderbyuserid).toBeDefined();
        });
    });
    describe('Testing order Model methods logic', function () {
        var test_user = {
            user_name: 'testapi',
            first_name: 'test',
            second_name: '2',
        ...
        it('create method should add an order', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, order_entity.create({
                            status: true,
                            // @ts-ignore
                            user_id: idofuser,
                        })];
        ...
        it('index method should return a list of orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, order_entity.index()];
                    case 1:
                        result = _a.sent();
        ...
        it('getorderbyid method should return the correct order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, order_entity.getorderbyid(
                        // @ts-ignore
                        idoforder)];
                    case 1:
                        result = _a.sent();
        ...
        it('getorderbyuserid method should return the correct order', function () { return __awaiter(void 0, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, order_entity.getorderbyuserid(
                        // @ts-ignore
                        idofuser)];
                    case 1:
                        result = _a.sent();
        ...
        it('delete method should remove the order', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, order_entity.delete(idoforder)];
                    case 1:
                        a = _a.sent();
                        return [4 /*yield*/, order_entity.index()];
                    case 2:
                        result = _a.sent();
